define(
    ...
    function (
        ...
        function initPaymentPage() {
            var endpoint = urlBuilder.build('ecommpay/startpayment/index?method=google_pay_host');
            jQuery.ajax({
                method: 'POST',
                url: endpoint,
                dataType: 'json',
        ...
        return Component.extend({
            ...
            getDescription: function() {
                return window.checkoutConfig.ecommpay_settings.descriptions.ecommpay_googlepay;
            }
        });
    }
);