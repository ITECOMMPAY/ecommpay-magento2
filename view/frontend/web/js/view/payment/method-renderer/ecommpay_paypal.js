define(
    ...
    function (
        ...
        function initPaymentPage() {
            var endpoint = urlBuilder.build('ecommpay/startpayment/index?method=paypal-wallet');
            jQuery.ajax({
                method: 'POST',
                url: endpoint,
                dataType: 'json',
        ...
        return Component.extend({
            ...
            getDescription: function() {
                return window.checkoutConfig.ecommpay_settings.descriptions.ecommpay_paypal;
            }
        });
    }
);