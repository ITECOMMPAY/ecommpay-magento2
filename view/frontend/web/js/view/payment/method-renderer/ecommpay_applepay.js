define(
    ...
    function (
        ...
        function initPaymentPage() {
            var endpoint = urlBuilder.build('ecommpay/startpayment/index?method=apple_pay_core');
        ...
        return Component.extend({
            ...
            getDescription: function() {
                return window.checkoutConfig.ecommpay_settings.descriptions.ecommpay_applepay;
            }
        });
    }
);